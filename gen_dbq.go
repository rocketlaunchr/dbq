...
type Options struct {
	...
	// Raw can be set to true to bypass all Database specific operations and handle a data
	// directly without any database specifici processing
	Raw bool
}
